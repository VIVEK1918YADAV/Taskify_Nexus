...
import { useLazyVerifyTokenQuery } from "./redux/slices/api/authApiSlice";
    ...
    const validateToken = async () => {
      if (user && user.token) {
        try {
          ...
          // This prevents the user from being automatically redirected to dashboard with invalid token
